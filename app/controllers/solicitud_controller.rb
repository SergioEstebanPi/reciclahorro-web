class SolicitudController < ApplicationController
  ...
  # DELETE /solicitud/1
  # DELETE /solicitud/1.json
  def destroy
    @solicitud.destroy
    respond_to do |format|
      format.html { redirect_to solicitud_index_url, notice: 'Solicitud was successfully destroyed.' }
  ...
  private
    ...
    def solicitud_params
      params.require(:solicitud).permit(:titulo, :descripcion, :fecha_recoleccion, :usuario_id)
    end
end
