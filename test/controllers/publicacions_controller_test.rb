...
class PublicacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacion" do
    assert_difference('Publicacion.count') do
      post publicacions_url, params: { publicacion: { descripcion: @publicacion.descripcion, imagen: @publicacion.imagen, tipo: @publicacion.tipo, titulo: @publicacion.titulo } }
    end
  ...
  test "should update publicacion" do
    patch publicacion_url(@publicacion), params: { publicacion: { descripcion: @publicacion.descripcion, imagen: @publicacion.imagen, tipo: @publicacion.tipo, titulo: @publicacion.titulo } }
