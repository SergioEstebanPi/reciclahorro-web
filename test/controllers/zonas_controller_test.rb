...
class ZonasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zona" do
    assert_difference('Zona.count') do
      post zonas_url, params: { zona: { descripcion: @zona.descripcion, nombre: @zona.nombre } }
    end
  ...
  test "should update zona" do
    patch zona_url(@zona), params: { zona: { descripcion: @zona.descripcion, nombre: @zona.nombre } }
